...
<div class="col-12 col-lg-3">
	...
	<ul>
		...
		?>
		<li class="no-before"><b class="text-uppercase"><?= $titel; ?></b><?php if($link):?><a class="text-white" href="<?= $link; ?>"<?php if($neuer_tab == 'Ja'):?> target="_blank"<?php endif;?>><?php endif;?> <?= $text; ?><?php if($link):?></a><?php endif;?></li>
		<?php endwhile;?>
	</ul>
	<?php endif; ?>
</div>
